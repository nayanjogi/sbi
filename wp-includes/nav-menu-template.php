...
class Walker_Nav_Menu extends Walker {
	...
	function start_el(&$output, $item, $depth, $args) {
		...
		if($item->ID == 173 || $item->ID == 123 || $item->ID == 337 || $item->ID == 129 || $item->ID == 389)
			$class_names = ' class="' . esc_attr( $class_names ) . ' last"';
		else
...
function wp_nav_menu( $args = array() ) {
	...
	$defaults = array( 'menu' => '', 'container' => '', 'container_class' => 'clearfix', 'container_id' => '', 'menu_class' => 'clearfix', 'menu_id' => '',
