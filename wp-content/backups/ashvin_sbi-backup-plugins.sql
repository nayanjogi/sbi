...
-- Version 1.5.4
-- http://wpb2d.com
-- Generation Time: July 20, 2013 at 18:11
...
CREATE DATABASE IF NOT EXISTS ashvin_sbi;
USE ashvin_sbi;
...
('1', '1', 'http://localhost/sbi/wp-content/uploads/2013/05/2-300x221.jpg', '', '', '0'),
('2', '1', 'http://localhost/sbi/wp-content/uploads/2012/08/0508-long-beach-framing2-300x203.jpg', '', '', '0');
...
('history', '1371574822,1371661431'),
('in_progress', '1'),
('is_running', '1'),
('last_backup_time', '1371661431'),
('oauth_state', 'access'),
