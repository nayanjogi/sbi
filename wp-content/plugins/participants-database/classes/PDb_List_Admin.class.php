...
'order by'       => 'date_recorded',
  ...
  <div class="wrap pdb-list participants_db">
    ...
    <h3><?php printf( _n( 'List NAV: %s record found, sorted by:', 'List NAV: %s records found, sorted by:', self::$num_records ), self::$num_records )?>
     ...
     ?>
      ...
      <fieldset class="widefat">
        ...
        <form method="post">
          ...
          $suggested_filename = 'NAV -'.$date_string.'.csv';
          ...
          <p>
						<?php _e( 'This will download the whole list of NAVs that match your search terms, and in the order specified by the sort. The export will include records on all list pages. The fields included in the export are defined in the "CSV" column on the Manage Database Fields page.', 'participants-database'  )?>
          </p>
        </form>
      </fieldset>
