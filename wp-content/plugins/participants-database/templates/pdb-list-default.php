...
?>
   ...
   */ ?>
	...
	echo $record_count; 	if ( $display_count ) : ?>
    <caption>
...
.sorting_disabled
{
	border-color: rgb(238, 238, 238) rgb(153, 153, 153) rgb(119, 119, 119) rgb(187, 187, 187); border-style: solid; border-width: 1px; background-color: rgb(204, 204, 204); font-size: 12px;font-weight: bold; padding: 10px; text-align: center; font-family: Arial; text-decoration: none;
}
	.dataTables_empty {
	text-align: center;
}
...
.pdb-list .pagination li:first-of-type span, .pdb-list .pagination li:first-of-type a {
    margin-left: 0;
}
.pdb-list .pagination li:last-of-type span, .pdb-list .pagination li:last-of-type a {
    margin-right: 0;
}
.pdb-list .pagination li.currentpage:first-child, .pdb-list .pagination li:first-child a {
    margin-left: 0;
}
.pdb-list .pagination a {
    text-decoration: none;
}
.pdb-list .pagination a:hover, .pdb-list .pagination li.currentpage {
