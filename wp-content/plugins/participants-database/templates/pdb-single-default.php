...
<div class="wrap <?php echo $this->wrap_class ?>">
  ...
  <div class="section" id="<?php echo Participants_Db::$css_prefix.$this->group->name ?>">
    ...
    <?php // $this->group->print_description( '<p>', '</p>' ) ?>
      ...
      ?>
      <div style="width:300px;"><span class="titlediv" style="font-weight:bold;font-size:14px;padding:5px; " ><?php $this->field->print_label() ?>  </span>:<span> <?php $this->field->print_value() ?> </span>
      <p><?php //$this->field->print_value() ?></p>
      <h2 class="title"></h2>
      </div>
